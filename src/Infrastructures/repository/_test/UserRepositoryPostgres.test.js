...
describe('UserRepositoryPostgres', () => {
  ...
  describe('getPasswordByUsername', () => {
    it('should throw AuthenticationError when user not found', async () => {
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
      await expect(userRepositoryPostgres.getPasswordByUsername('dicoding')).rejects.toThrowError(AuthenticationError);
    });
  ...
  describe('getIdByUsername', () => {
    it('should throw NotFoundError when user not found', async () => {
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
      await expect(userRepositoryPostgres.getIdByUsername('dicoding')).rejects.toThrowError(NotFoundError);
    });
